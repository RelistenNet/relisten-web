...
export const PopoverClose = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  (props, ref) => {
...
export const SimplePopover = ({ content, children, position, disabled }: SimplePopoverProps) => {
  return (
