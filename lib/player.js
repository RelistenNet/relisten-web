...
export function initGaplessPlayer(nextStore) {
  ...
  // I'm disabling web audio for everyone temporarily due to this bug https://github.com/RelistenNet/relisten-web/issues/49
  if (!Number(localStorage.forceGaplessOn) && (isMobile || isFirefox || true)) player.disableWebAudio(); // eslint-disable-line no-constant-condition
